#source https://github.com/c3e/gridpy
try:
...
if __name__ == '__main__':
    ...
    resized_img=cv2.resize(image,((int(image.shape[1] * 20)),(int(image.shape[0] * 20))),interpolation = cv2.INTER_AREA)
    cv2.imwrite("spark.jpg",resized_img)
    print(resized_img)
    while False:
